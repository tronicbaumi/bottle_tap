// template.scadtranslate([0,6,1])rotate([0,0,0])cylinder(4,4.1,4.1/2);
...
module plus()
{   
    translate([10,0,0])rotate([0,0,0])cube([25,30,4.5],false);
    translate([-10-25,0,0])rotate([0,0,0])cube([25,30,4.5],false);
//    translate([0,0,12])rotate([0,0,0])cylinder(l1,12/2,11.8/2);
}

module minus()
{
    translate([-40,6,4])rotate([0,90,0])cylinder(80,4.1/2,4.1/2);
    
    translate([-15,0,4])rotate([0,90,90])cylinder(30,4.1/2,4.1/2);
    translate([15,0,4])rotate([0,90,90])cylinder(30,4.1/2,4.1/2);
    
    translate([0,-43,0])rotate([0,0,45])cube([50,50,4.5],false);
