...
{   
    ...
    translate([0,0,0])rotate([0,0,0])cube([35,25,25]);
//    translate([0,0,20])rotate([0,0,0])cube([100,2,2]);
    
   //     translate([28,26,25/2])rotate([90,0,0])cylinder(30,10.2/2,10.2/2,$fn=4);
...
//    translate([10,9.5,0])rotate([0,0,0])cylinder(2,8/2,5/2);
//    
//    translate([30,9.5,0])rotate([0,0,0])cylinder(20,5/2,5/2);
//    translate([30,9.5,0])rotate([0,0,0])cylinder(2,8/2,5/2);
//    
//    translate([70,9.5,0])rotate([0,0,0])cylinder(20,5/2,5/2);
//    translate([70,9.5,0])rotate([0,0,0])cylinder(2,8/2,5/2);
//    
//    translate([90,9.5,0])rotate([0,0,0])cylinder(20,5/2,5/2);
//    translate([90,9.5,0])rotate([0,0,0])cylinder(2,8/2,5/2);
//    
//    
//    translate([10,9.5+42,0])rotate([0,0,0])cylinder(20,5/2,5/2);
//    translate([10,9.5+42,0])rotate([0,0,0])cylinder(2,8/2,5/2);
//    
//    translate([30,9.5+42,0])rotate([0,0,0])cylinder(20,5/2,5/2);
//    translate([30,9.5+42,0])rotate([0,0,0])cylinder(2,8/2,5/2);
//    
//    translate([70,9.5+42,0])rotate([0,0,0])cylinder(20,5/2,5/2);
//    translate([70,9.5+42,0])rotate([0,0,0])cylinder(2,8/2,5/2);
//    
//    translate([90,9.5+42,0])rotate([0,0,0])cylinder(20,5/2,5/2);
//    translate([90,9.5+42,0])rotate([0,0,0])cylinder(2,8/2,5/2);
