...
#include "ConvFnc_TrackingLoop_FiP32.h"
...
/** Private prototypes */
static uint8 convertM2I(const TRACKINGLOOP_FIP32_MASK_PARAM *maskParam, TRACKINGLOOP_FIP32_IMPL_PARAM *impParam, float_CoT ts);
...
uint8 TrackingLoop_FiP32_SaveMP(TRACKINGLOOP_FIP32 *block, TRACKINGLOOP_FIP32_MASK_PARAM *maskParam, const uint8 data[], uint16 dataLen)
{
    ...
    else
    {
        ...
        TrackingLoop_FiP32_BackupMP(maskParam);
        ...
        error = TrackingLoop_FiP32_ConvertMP(block, maskParam);

        /** - Check for errors during execution of save function */
        if (error != 0)
        {
            /* Restore old mask parameter */
            TrackingLoop_FiP32_RestoreMP(maskParam);
        }
...
uint8 TrackingLoop_FiP32_InitMP(TRACKINGLOOP_FIP32 *block, const TRACKINGLOOP_FIP32_MASK_PARAM *maskParam)
{
    ...
    TRACKINGLOOP_FIP32_IMPL_PARAM *implParam = (TRACKINGLOOP_FIP32_IMPL_PARAM*)ImplParamBuffer;
    ...
    SaveFncDataBuffer[0] = (uint8)(implParam->vGain & 0x000000FF);
    SaveFncDataBuffer[1] = (uint8)((implParam->vGain >> 8) & 0x000000FF);
    SaveFncDataBuffer[2] = (uint8)((implParam->vGain >> 16) & 0x000000FF);
    SaveFncDataBuffer[3] = (uint8)((implParam->vGain >> 24) & 0x000000FF);
    ...
    SaveFncDataBuffer[15] = (uint8)(implParam->b0_speed & 0x000000FF);
    SaveFncDataBuffer[16] = (uint8)((implParam->b0_speed >> 8) & 0x000000FF);
    SaveFncDataBuffer[17] = (uint8)((implParam->b0_speed >> 16) & 0x000000FF);
    SaveFncDataBuffer[18] = (uint8)((implParam->b0_speed >> 24) & 0x000000FF);
    SaveFncDataBuffer[19] = (uint8)(implParam->b1_speed & 0x000000FF);
    SaveFncDataBuffer[20] = (uint8)((implParam->b1_speed >> 8) & 0x000000FF);
    SaveFncDataBuffer[21] = (uint8)((implParam->b1_speed >> 16) & 0x000000FF);
    SaveFncDataBuffer[22] = (uint8)((implParam->b1_speed >> 24) & 0x000000FF);
    SaveFncDataBuffer[23] = (uint8)implParam->sfrb0_speed;
    SaveFncDataBuffer[24] = (uint8)implParam->sfrb1_speed;
    SaveFncDataBuffer[25] = (uint8)(implParam->b0_angle & 0x000000FF);
    SaveFncDataBuffer[26] = (uint8)((implParam->b0_angle >> 8) & 0x000000FF);
    SaveFncDataBuffer[27] = (uint8)((implParam->b0_angle >> 16) & 0x000000FF);
    SaveFncDataBuffer[28] = (uint8)((implParam->b0_angle >> 24) & 0x000000FF);
    SaveFncDataBuffer[29] = (uint8)(implParam->b1_angle & 0x000000FF);
    SaveFncDataBuffer[30] = (uint8)((implParam->b1_angle >> 8) & 0x000000FF);
    SaveFncDataBuffer[31] = (uint8)((implParam->b1_angle >> 16) & 0x000000FF);
    SaveFncDataBuffer[32] = (uint8)((implParam->b1_angle >> 24) & 0x000000FF);
    SaveFncDataBuffer[33] = (uint8)implParam->sfrb0_angle;
    SaveFncDataBuffer[34] = (uint8)implParam->sfrb1_angle;
    SaveFncDataBuffer[35] = (uint8)implParam->rawSpeed;

    /** - Execute save function of block */
    error = TrackingLoop_FiP32_Save(block, SaveFncDataBuffer, 36);
