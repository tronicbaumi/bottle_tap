...
#include "ConvFnc_TrackingLoop_Float32.h"
...
typedef struct {
    ...
    float32 b1_angle;
    bool rawSpeed;
} TRACKINGLOOP_FLOAT32_IMPL_PARAM;
...
/** Private prototypes */
static uint8 convertM2I(const TRACKINGLOOP_FLOAT32_MASK_PARAM *maskParam, TRACKINGLOOP_FLOAT32_IMPL_PARAM *impParam, float_CoT ts);
 ...
 */
uint8 TrackingLoop_Float32_LoadMP(const TRACKINGLOOP_FLOAT32_MASK_PARAM *maskParam, uint8 data[], uint16* dataLen, uint16 maxSize)
{
    uint8 error = (uint8)0;
 ...
 */
uint8 TrackingLoop_Float32_SaveMP(TRACKINGLOOP_FLOAT32 *block, TRACKINGLOOP_FLOAT32_MASK_PARAM *maskParam, const uint8 data[], uint16 dataLen)
{
    uint8 error = (uint8)0;
    ...
    else
    {
        ...
        TrackingLoop_Float32_BackupMP(maskParam);
        ...
        error = TrackingLoop_Float32_ConvertMP(block, maskParam);

        /** - Check for errors during execution of save function */
        if (error != 0)
        {
            /* Restore old mask parameter */
            TrackingLoop_Float32_RestoreMP(maskParam);
        }
 ...
 */
uint8 TrackingLoop_Float32_InitMP(TRACKINGLOOP_FLOAT32 *block, const TRACKINGLOOP_FLOAT32_MASK_PARAM *maskParam)
{
    uint8 error = (uint8)0;
    float_CoT block_ts;

    TRACKINGLOOP_FLOAT32_IMPL_PARAM *implParam = (TRACKINGLOOP_FLOAT32_IMPL_PARAM*)ImplParamBuffer;
    ...
    SaveFncDataBuffer[0] = (uint8)((*(uint32*)&(implParam->vGain)) & 0x000000FF);
    SaveFncDataBuffer[1] = (uint8)((*(uint32*)&(implParam->vGain) >> 8) & 0x000000FF);
    SaveFncDataBuffer[2] = (uint8)((*(uint32*)&(implParam->vGain) >> 16) & 0x000000FF);
    SaveFncDataBuffer[3] = (uint8)((*(uint32*)&(implParam->vGain) >> 24) & 0x000000FF);
    SaveFncDataBuffer[4] = (uint8)((*(uint32*)&(implParam->b0_torque)) & 0x000000FF);
    SaveFncDataBuffer[5] = (uint8)((*(uint32*)&(implParam->b0_torque) >> 8) & 0x000000FF);
    SaveFncDataBuffer[6] = (uint8)((*(uint32*)&(implParam->b0_torque) >> 16) & 0x000000FF);
    SaveFncDataBuffer[7] = (uint8)((*(uint32*)&(implParam->b0_torque) >> 24) & 0x000000FF);
    SaveFncDataBuffer[8] = (uint8)((*(uint32*)&(implParam->b1_torque)) & 0x000000FF);
    SaveFncDataBuffer[9] = (uint8)((*(uint32*)&(implParam->b1_torque) >> 8) & 0x000000FF);
    SaveFncDataBuffer[10] = (uint8)((*(uint32*)&(implParam->b1_torque) >> 16) & 0x000000FF);
    SaveFncDataBuffer[11] = (uint8)((*(uint32*)&(implParam->b1_torque) >> 24) & 0x000000FF);
    SaveFncDataBuffer[12] = (uint8)((*(uint32*)&(implParam->b0_speed)) & 0x000000FF);
    SaveFncDataBuffer[13] = (uint8)((*(uint32*)&(implParam->b0_speed) >> 8) & 0x000000FF);
    SaveFncDataBuffer[14] = (uint8)((*(uint32*)&(implParam->b0_speed) >> 16) & 0x000000FF);
    SaveFncDataBuffer[15] = (uint8)((*(uint32*)&(implParam->b0_speed) >> 24) & 0x000000FF);
    SaveFncDataBuffer[16] = (uint8)((*(uint32*)&(implParam->b1_speed)) & 0x000000FF);
    SaveFncDataBuffer[17] = (uint8)((*(uint32*)&(implParam->b1_speed) >> 8) & 0x000000FF);
    SaveFncDataBuffer[18] = (uint8)((*(uint32*)&(implParam->b1_speed) >> 16) & 0x000000FF);
    SaveFncDataBuffer[19] = (uint8)((*(uint32*)&(implParam->b1_speed) >> 24) & 0x000000FF);
    SaveFncDataBuffer[20] = (uint8)((*(uint32*)&(implParam->b0_angle)) & 0x000000FF);
    SaveFncDataBuffer[21] = (uint8)((*(uint32*)&(implParam->b0_angle) >> 8) & 0x000000FF);
    SaveFncDataBuffer[22] = (uint8)((*(uint32*)&(implParam->b0_angle) >> 16) & 0x000000FF);
    SaveFncDataBuffer[23] = (uint8)((*(uint32*)&(implParam->b0_angle) >> 24) & 0x000000FF);
    SaveFncDataBuffer[24] = (uint8)((*(uint32*)&(implParam->b1_angle)) & 0x000000FF);
    SaveFncDataBuffer[25] = (uint8)((*(uint32*)&(implParam->b1_angle) >> 8) & 0x000000FF);
    SaveFncDataBuffer[26] = (uint8)((*(uint32*)&(implParam->b1_angle) >> 16) & 0x000000FF);
    SaveFncDataBuffer[27] = (uint8)((*(uint32*)&(implParam->b1_angle) >> 24) & 0x000000FF);
    SaveFncDataBuffer[28] = (uint8)implParam->rawSpeed;

    /** - Execute save function of block */
    error = TrackingLoop_Float32_Save(block, SaveFncDataBuffer, 29);
 ...
 */
uint8 TrackingLoop_Float32_ConvertMP(TRACKINGLOOP_FLOAT32 *block, TRACKINGLOOP_FLOAT32_MASK_PARAM *maskParam)
{
    uint8 error;
    float_CoT block_ts;
    TRACKINGLOOP_FLOAT32_IMPL_PARAM *implParam = (TRACKINGLOOP_FLOAT32_IMPL_PARAM*)ImplParamBuffer;
 ...
 * @return Nothing
 */
void TrackingLoop_Float32_BackupMP(TRACKINGLOOP_FLOAT32_MASK_PARAM* maskParam)
{
 ...
 * @return Nothing
 */
void TrackingLoop_Float32_RestoreMP(TRACKINGLOOP_FLOAT32_MASK_PARAM* maskParam)
{
