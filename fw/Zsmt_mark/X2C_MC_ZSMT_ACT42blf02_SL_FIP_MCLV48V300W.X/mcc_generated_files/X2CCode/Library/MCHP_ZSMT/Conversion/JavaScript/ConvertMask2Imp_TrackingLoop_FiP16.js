...
cp_sfrb0_angle = getQFormat(b0, BITS16, true);
cp_b0_angle  = getQValue(b0, cp_sfrb0_angle, BITS16, true);

cp_sfrb1_angle = getQFormat(b1, BITS16, true);
cp_b1_angle    = getQValue(b1, cp_sfrb1_angle, BITS16, true);
...
cp_sfrGain  = getQFormat(V, BITS16, true);
cp_vGain    = getQValue(V, cp_sfrGain, BITS16, true);
