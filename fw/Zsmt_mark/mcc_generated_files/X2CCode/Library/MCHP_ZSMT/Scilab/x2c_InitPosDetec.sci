...
function [x_sci,y_sci,typ_sci] = x2c_InitPosDetec(job, arg1, arg2)

thisBlockData.Library = "MCHP_ZSMT";
thisBlockData.block_type_name = "InitPosDetect";
thisBlockData.block_xcosfilename = "x2c_InitPosDetec";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_InitPosDetec_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_InitPosDetec_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../Doc/Images/InitPosDetect.svg"
