...
function [x_sci,y_sci,typ_sci] = x2c_EstimatorSwi(job, arg1, arg2)

thisBlockData.Library = "MCHP_ZSMT";
thisBlockData.block_type_name = "EstimatorSwitch";
thisBlockData.block_xcosfilename = "x2c_EstimatorSwi";
...
case "set" then
    ...
    while %t do
        ...
        block_model.sim = list("x2c_EstimatorSwi_"  + used_impl + "_C", 4);
...
case "define" then
    ...
    model = scicos_model();
    used_impl = jinvoke(x2cPEdit, "getUsedImplementationName");
    model.sim = list("x2c_EstimatorSwi_"  + used_impl + "_C", 4);
...
style_tmp.image = "file:///" + pwd() + "/../Doc/Images/EstimatorSwitch.svg"
