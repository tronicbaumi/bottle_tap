...
#include "ConvFnc_HFInjectionSquare_Float64.h"
...
typedef struct {
    ...
    float64 b1_angle;
    bool rawSpeed;
} HFINJECTIONSQUARE_FLOAT64_IMPL_PARAM;
...
/** Private prototypes */
static uint8 convertM2I(const HFINJECTIONSQUARE_FLOAT64_MASK_PARAM *maskParam, HFINJECTIONSQUARE_FLOAT64_IMPL_PARAM *impParam, float_CoT ts);
...
uint8 HFInjectionSquare_Float64_SaveMP(HFINJECTIONSQUARE_FLOAT64 *block, HFINJECTIONSQUARE_FLOAT64_MASK_PARAM *maskParam, const uint8 data[], uint16 dataLen)
{
    ...
    else
    {
        ...
        HFInjectionSquare_Float64_BackupMP(maskParam);
        ...
        error = HFInjectionSquare_Float64_ConvertMP(block, maskParam);

        /** - Check for errors during execution of save function */
        if (error != 0)
        {
            /* Restore old mask parameter */
            HFInjectionSquare_Float64_RestoreMP(maskParam);
        }
...
uint8 HFInjectionSquare_Float64_InitMP(HFINJECTIONSQUARE_FLOAT64 *block, const HFINJECTIONSQUARE_FLOAT64_MASK_PARAM *maskParam)
{
    ...
    HFINJECTIONSQUARE_FLOAT64_IMPL_PARAM *implParam = (HFINJECTIONSQUARE_FLOAT64_IMPL_PARAM*)ImplParamBuffer;
    ...
    SaveFncDataBuffer[0] = (uint8)((*(uint64*)&(implParam->uInjAmp)) & 0x00000000000000FF);
    SaveFncDataBuffer[1] = (uint8)((*(uint64*)&(implParam->uInjAmp) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[2] = (uint8)((*(uint64*)&(implParam->uInjAmp) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[3] = (uint8)((*(uint64*)&(implParam->uInjAmp) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[4] = (uint8)((*(uint64*)&(implParam->uInjAmp) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[5] = (uint8)((*(uint64*)&(implParam->uInjAmp) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[6] = (uint8)((*(uint64*)&(implParam->uInjAmp) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[7] = (uint8)((*(uint64*)&(implParam->uInjAmp) >> 56) & 0x00000000000000FF);
    SaveFncDataBuffer[8] = (uint8)((*(uint64*)&(implParam->vGain)) & 0x00000000000000FF);
    SaveFncDataBuffer[9] = (uint8)((*(uint64*)&(implParam->vGain) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[10] = (uint8)((*(uint64*)&(implParam->vGain) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[11] = (uint8)((*(uint64*)&(implParam->vGain) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[12] = (uint8)((*(uint64*)&(implParam->vGain) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[13] = (uint8)((*(uint64*)&(implParam->vGain) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[14] = (uint8)((*(uint64*)&(implParam->vGain) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[15] = (uint8)((*(uint64*)&(implParam->vGain) >> 56) & 0x00000000000000FF);
    SaveFncDataBuffer[16] = (uint8)((*(uint64*)&(implParam->b0_torque)) & 0x00000000000000FF);
    SaveFncDataBuffer[17] = (uint8)((*(uint64*)&(implParam->b0_torque) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[18] = (uint8)((*(uint64*)&(implParam->b0_torque) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[19] = (uint8)((*(uint64*)&(implParam->b0_torque) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[20] = (uint8)((*(uint64*)&(implParam->b0_torque) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[21] = (uint8)((*(uint64*)&(implParam->b0_torque) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[22] = (uint8)((*(uint64*)&(implParam->b0_torque) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[23] = (uint8)((*(uint64*)&(implParam->b0_torque) >> 56) & 0x00000000000000FF);
    SaveFncDataBuffer[24] = (uint8)((*(uint64*)&(implParam->b1_torque)) & 0x00000000000000FF);
    SaveFncDataBuffer[25] = (uint8)((*(uint64*)&(implParam->b1_torque) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[26] = (uint8)((*(uint64*)&(implParam->b1_torque) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[27] = (uint8)((*(uint64*)&(implParam->b1_torque) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[28] = (uint8)((*(uint64*)&(implParam->b1_torque) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[29] = (uint8)((*(uint64*)&(implParam->b1_torque) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[30] = (uint8)((*(uint64*)&(implParam->b1_torque) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[31] = (uint8)((*(uint64*)&(implParam->b1_torque) >> 56) & 0x00000000000000FF);
    SaveFncDataBuffer[32] = (uint8)((*(uint64*)&(implParam->b0_speed)) & 0x00000000000000FF);
    SaveFncDataBuffer[33] = (uint8)((*(uint64*)&(implParam->b0_speed) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[34] = (uint8)((*(uint64*)&(implParam->b0_speed) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[35] = (uint8)((*(uint64*)&(implParam->b0_speed) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[36] = (uint8)((*(uint64*)&(implParam->b0_speed) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[37] = (uint8)((*(uint64*)&(implParam->b0_speed) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[38] = (uint8)((*(uint64*)&(implParam->b0_speed) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[39] = (uint8)((*(uint64*)&(implParam->b0_speed) >> 56) & 0x00000000000000FF);
    SaveFncDataBuffer[40] = (uint8)((*(uint64*)&(implParam->b1_speed)) & 0x00000000000000FF);
    SaveFncDataBuffer[41] = (uint8)((*(uint64*)&(implParam->b1_speed) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[42] = (uint8)((*(uint64*)&(implParam->b1_speed) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[43] = (uint8)((*(uint64*)&(implParam->b1_speed) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[44] = (uint8)((*(uint64*)&(implParam->b1_speed) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[45] = (uint8)((*(uint64*)&(implParam->b1_speed) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[46] = (uint8)((*(uint64*)&(implParam->b1_speed) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[47] = (uint8)((*(uint64*)&(implParam->b1_speed) >> 56) & 0x00000000000000FF);
    SaveFncDataBuffer[48] = (uint8)((*(uint64*)&(implParam->b0_angle)) & 0x00000000000000FF);
    SaveFncDataBuffer[49] = (uint8)((*(uint64*)&(implParam->b0_angle) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[50] = (uint8)((*(uint64*)&(implParam->b0_angle) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[51] = (uint8)((*(uint64*)&(implParam->b0_angle) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[52] = (uint8)((*(uint64*)&(implParam->b0_angle) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[53] = (uint8)((*(uint64*)&(implParam->b0_angle) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[54] = (uint8)((*(uint64*)&(implParam->b0_angle) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[55] = (uint8)((*(uint64*)&(implParam->b0_angle) >> 56) & 0x00000000000000FF);
    SaveFncDataBuffer[56] = (uint8)((*(uint64*)&(implParam->b1_angle)) & 0x00000000000000FF);
    SaveFncDataBuffer[57] = (uint8)((*(uint64*)&(implParam->b1_angle) >> 8) & 0x00000000000000FF);
    SaveFncDataBuffer[58] = (uint8)((*(uint64*)&(implParam->b1_angle) >> 16) & 0x00000000000000FF);
    SaveFncDataBuffer[59] = (uint8)((*(uint64*)&(implParam->b1_angle) >> 24) & 0x00000000000000FF);
    SaveFncDataBuffer[60] = (uint8)((*(uint64*)&(implParam->b1_angle) >> 32) & 0x00000000000000FF);
    SaveFncDataBuffer[61] = (uint8)((*(uint64*)&(implParam->b1_angle) >> 40) & 0x00000000000000FF);
    SaveFncDataBuffer[62] = (uint8)((*(uint64*)&(implParam->b1_angle) >> 48) & 0x00000000000000FF);
    SaveFncDataBuffer[63] = (uint8)((*(uint64*)&(implParam->b1_angle) >> 56) & 0x00000000000000FF);
    SaveFncDataBuffer[64] = (uint8)implParam->rawSpeed;

    /** - Execute save function of block */
    error = HFInjectionSquare_Float64_Save(block, SaveFncDataBuffer, 65);
