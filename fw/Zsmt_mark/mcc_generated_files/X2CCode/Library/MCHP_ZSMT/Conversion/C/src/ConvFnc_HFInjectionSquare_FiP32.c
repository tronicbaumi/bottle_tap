...
#include "ConvFnc_HFInjectionSquare_FiP32.h"
...
typedef struct {
    ...
    int8 sfrb1_angle;
    bool rawSpeed;
} HFINJECTIONSQUARE_FIP32_IMPL_PARAM;
...
/** Private prototypes */
static uint8 convertM2I(const HFINJECTIONSQUARE_FIP32_MASK_PARAM *maskParam, HFINJECTIONSQUARE_FIP32_IMPL_PARAM *impParam, float_CoT ts);
...
/* USERCODE-BEGIN:Conversion                                                                                          */
        ...
        /******************** HF injection ********************/
        impParam->uInjAmp = getQx32Value(ampHF / UDCmax, 31);
        ...
        /* b0 */
        impParam->sfrb0_speed = getQFormat(b0, 32);
        impParam->b0_speed = getQx32Value(b0, impParam->sfrb0_speed);
        /* b1 */
        impParam->sfrb1_speed = getQFormat(b1, 32);
        impParam->b1_speed = getQx32Value(b1, impParam->sfrb1_speed);
        ...
        /* b0 */
        impParam->sfrb0_angle = getQFormat(b0, 32);
        impParam->b0_angle = getQx32Value(b0, impParam->sfrb0_angle);
        /* b1 */
        impParam->sfrb1_angle = getQFormat(b1, 32);
        impParam->b1_angle = getQx32Value(b1, impParam->sfrb1_angle);

        
        /******************** Gain ********************/
        V = I2phi * phi2speed * 3 * rho;

        impParam->sfrGain = getQFormat(V, 32);
        impParam->vGain = getQx32Value(V, impParam->sfrGain);
...
uint8 HFInjectionSquare_FiP32_SaveMP(HFINJECTIONSQUARE_FIP32 *block, HFINJECTIONSQUARE_FIP32_MASK_PARAM *maskParam, const uint8 data[], uint16 dataLen)
{
    ...
    else
    {
        ...
        HFInjectionSquare_FiP32_BackupMP(maskParam);
        ...
        error = HFInjectionSquare_FiP32_ConvertMP(block, maskParam);

        /** - Check for errors during execution of save function */
        if (error != 0)
        {
            /* Restore old mask parameter */
            HFInjectionSquare_FiP32_RestoreMP(maskParam);
        }
...
uint8 HFInjectionSquare_FiP32_InitMP(HFINJECTIONSQUARE_FIP32 *block, const HFINJECTIONSQUARE_FIP32_MASK_PARAM *maskParam)
{
    ...
    HFINJECTIONSQUARE_FIP32_IMPL_PARAM *implParam = (HFINJECTIONSQUARE_FIP32_IMPL_PARAM*)ImplParamBuffer;
    ...
    SaveFncDataBuffer[0] = (uint8)(implParam->uInjAmp & 0x000000FF);
    SaveFncDataBuffer[1] = (uint8)((implParam->uInjAmp >> 8) & 0x000000FF);
    SaveFncDataBuffer[2] = (uint8)((implParam->uInjAmp >> 16) & 0x000000FF);
    SaveFncDataBuffer[3] = (uint8)((implParam->uInjAmp >> 24) & 0x000000FF);
    SaveFncDataBuffer[4] = (uint8)(implParam->vGain & 0x000000FF);
    SaveFncDataBuffer[5] = (uint8)((implParam->vGain >> 8) & 0x000000FF);
    SaveFncDataBuffer[6] = (uint8)((implParam->vGain >> 16) & 0x000000FF);
    SaveFncDataBuffer[7] = (uint8)((implParam->vGain >> 24) & 0x000000FF);
    SaveFncDataBuffer[8] = (uint8)implParam->sfrGain;
    SaveFncDataBuffer[9] = (uint8)(implParam->b0_torque & 0x000000FF);
    SaveFncDataBuffer[10] = (uint8)((implParam->b0_torque >> 8) & 0x000000FF);
    SaveFncDataBuffer[11] = (uint8)((implParam->b0_torque >> 16) & 0x000000FF);
    SaveFncDataBuffer[12] = (uint8)((implParam->b0_torque >> 24) & 0x000000FF);
    SaveFncDataBuffer[13] = (uint8)(implParam->b1_torque & 0x000000FF);
    SaveFncDataBuffer[14] = (uint8)((implParam->b1_torque >> 8) & 0x000000FF);
    SaveFncDataBuffer[15] = (uint8)((implParam->b1_torque >> 16) & 0x000000FF);
    SaveFncDataBuffer[16] = (uint8)((implParam->b1_torque >> 24) & 0x000000FF);
    SaveFncDataBuffer[17] = (uint8)implParam->sfrb0_torque;
    SaveFncDataBuffer[18] = (uint8)implParam->sfrb1_torque;
    SaveFncDataBuffer[19] = (uint8)(implParam->b0_speed & 0x000000FF);
    SaveFncDataBuffer[20] = (uint8)((implParam->b0_speed >> 8) & 0x000000FF);
    SaveFncDataBuffer[21] = (uint8)((implParam->b0_speed >> 16) & 0x000000FF);
    SaveFncDataBuffer[22] = (uint8)((implParam->b0_speed >> 24) & 0x000000FF);
    SaveFncDataBuffer[23] = (uint8)(implParam->b1_speed & 0x000000FF);
    SaveFncDataBuffer[24] = (uint8)((implParam->b1_speed >> 8) & 0x000000FF);
    SaveFncDataBuffer[25] = (uint8)((implParam->b1_speed >> 16) & 0x000000FF);
    SaveFncDataBuffer[26] = (uint8)((implParam->b1_speed >> 24) & 0x000000FF);
    SaveFncDataBuffer[27] = (uint8)implParam->sfrb0_speed;
    SaveFncDataBuffer[28] = (uint8)implParam->sfrb1_speed;
    SaveFncDataBuffer[29] = (uint8)(implParam->b0_angle & 0x000000FF);
    SaveFncDataBuffer[30] = (uint8)((implParam->b0_angle >> 8) & 0x000000FF);
    SaveFncDataBuffer[31] = (uint8)((implParam->b0_angle >> 16) & 0x000000FF);
    SaveFncDataBuffer[32] = (uint8)((implParam->b0_angle >> 24) & 0x000000FF);
    SaveFncDataBuffer[33] = (uint8)(implParam->b1_angle & 0x000000FF);
    SaveFncDataBuffer[34] = (uint8)((implParam->b1_angle >> 8) & 0x000000FF);
    SaveFncDataBuffer[35] = (uint8)((implParam->b1_angle >> 16) & 0x000000FF);
    SaveFncDataBuffer[36] = (uint8)((implParam->b1_angle >> 24) & 0x000000FF);
    SaveFncDataBuffer[37] = (uint8)implParam->sfrb0_angle;
    SaveFncDataBuffer[38] = (uint8)implParam->sfrb1_angle;
    SaveFncDataBuffer[39] = (uint8)implParam->rawSpeed;

    /** - Execute save function of block */
    error = HFInjectionSquare_FiP32_Save(block, SaveFncDataBuffer, 40);
