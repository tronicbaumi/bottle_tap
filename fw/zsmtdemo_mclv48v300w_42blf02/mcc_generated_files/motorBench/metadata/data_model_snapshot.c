...
__attribute__((section("diagnostics_cinfo, info"), keep)) char MCAF_data_model_snapshot[] =
  ...
  ": 12.0}}}},\"autotune_result\": {\"current\": {\"Kp\": 0.495825392423,\"phase_ma"
  "rgin\": 80.0,\"wc\": 2951.71568387,\"Ki\": 1463.53558728,\"pi_phase_lag\": 45.0}"
  ",\"velocity\": {\"Kp\": 0.0229065231866,\"phase_margin\": 2.7,\"wc\": 85.8914322"
  "444,\"Ki\": 0.0996679374744,\"pi_phase_lag\": 2.9}},\"code_generation_tag_map\":"
  " {\"application\": \"sample\",\"diagnostics\": \"x2cscope\"},\"operating_range\""
  ": {\"velocity\": {\"units_qualifier\": \"mechanical\",\"units\": \"rad\\/s\",\"m"
  "inimum\": 130.89975}},\"build\": {\"hardware_spec\": \"mclv2:33ck256mp508_extopa"
  "mp_pim\",\"normfactor_associations\": [{\"context\": null,\"annotations\": [{\"t"
  "yperefs\": [\"MCAF_U_CURRENT_ABC\",\"MCAF_U_CURRENT_ALPHABETA\",\"MCAF_U_CURRENT"
  "_DQ\",\"MCAF_U_CURRENT\",\"MCAF_MOTOR_DATA.omegaCtrl.outMin\",\"MCAF_MOTOR_DATA."
  "omegaCtrl.outMax\"],\"unit\": \"I\",\"q\": 15},{\"typerefs\": [\"MCAF_MOTOR_DATA"
  ".omegaCtrl.integrator\"],\"unit\": \"I\",\"q\": 15},{\"typerefs\": [\"MCAF_U_VOL"
  "TAGE_ABC\",\"MCAF_U_VOLTAGE_ALPHABETA\",\"MCAF_U_VOLTAGE_DQ\",\"MCAF_U_VOLTAGE\""
  ",\"MCAF_MOTOR_DATA.idCtrl.outMin\",\"MCAF_MOTOR_DATA.idCtrl.outMax\",\"MCAF_MOTO"
  "R_DATA.iqCtrl.outMin\",\"MCAF_MOTOR_DATA.iqCtrl.outMax\"],\"unit\": \"V\",\"q\":"
  " 15},{\"typerefs\": [\"MCAF_MOTOR_DATA.idCtrl.integrator\",\"MCAF_MOTOR_DATA.iqC"
  "trl.integrator\"],\"unit\": \"V\",\"q\": 31},{\"typerefs\": [\"MCAF_U_DUTYCYCLE_"
  "ABC\"],\"unit\": 1,\"q\": 15},{\"typerefs\": [\"MCAF_U_ANGLE_ELEC\"],\"unit\": "
  "\"theta_e\",\"q\": 15},{\"typerefs\": [\"MCAF_U_ANGLE_MECH\"],\"unit\": \"theta_"
  "m\",\"q\": 15},{\"typerefs\": [\"MCAF_U_VELOCITY_MECH\"],\"unit\": \"omega_m\","
  "\"q\": 15},{\"typerefs\": [\"MCAF_U_VELOCITY_ELEC\"],\"unit\": \"omega_e\",\"q\""
  ": 15},{\"typerefs\": [\"MCAF_U_VELOCITY_DTHETA_ELEC_DT\"],\"unit\": \"dtheta_ele"
  "c_dt\",\"q\": 15},{\"typerefs\": [\"MCAF_U_TEMPERATURE\"],\"unit\": \"Temperatur"
  "e\",\"q\": 15},{\"typerefs\": [\"MCAF_U_DIMENSIONLESS\",\"MCAF_U_DIMENSIONLESS_S"
  "INCOS\"],\"unit\": 1,\"q\": 15},{\"typerefs\": [\"MCAF_U_NORMALIZED_GAIN\"],\"un"
  "it\": 1,\"q\": 14}]}]},\"drive\": {\"iout\": {\"measurement\": {\"compensation\""
  ": {\"channels\": [\"a\",\"b\"],\"values\": {\"a\": [1.0,0.0],\"b\": [0.0,1.0]},"
  "\"offset\": {\"range\": 0.03125,\"samples\": 128,\"filterGain\": 0.25}}},\"time_"
  "constant\": 5.971e-07,\"fullscale\": 22.044,\"maximum\": {\"continuous\": 16.79}"
  ...
  "e,\"operation-min_velocity_ratio\": 0.02,\"operation-startup_velocity_ratio\": 0"
  ".02,\"operation-max_velocity_ratio\": 1.2,\"operation-fullscale_base_ratio\": 1."
  "5,\"operation-outer_loop_type\": \"velocity\",\"operation-saliency-threshold\": "
  "1.2,\"operation-slewrate-accel\": 0.25,\"operation-slewrate-decel\": 1.0,\"opera"
  ...
  "\"operation-coastdown-time\": 2.0,\"fault_inject-get_tf-div0\": false,\"fault_in"
  ...
  "ct-stall_detect_enable\": false,\"startup-Istartup\": 0.1,\"startup-t_rampup\": "
  "25.0,\"startup-t_align\": 0.0,\"startup-min_total_accel_time\": 250.0,\"startup-"
  "torque_scale_accel\": 0.001,\"startup-torque_scale_slow_accel\": 0.2,\"startup-t"
  "_hold\": 0.0,\"startup-omega0\": 0.2,\"startup-theta_converge_rate\": 1.0,\"star"
  "tup-method\": \"zsmt_dsat\",\"startup-damping-Imax\": 0.5,\"startup-damping-gain"
  "max\": 100.0,\"startup-damping-omega_min\": 0.4,\"overmodulation-vd_limit\": 1.0"
  ",\"overmodulation-vq_limit\": 1.15,\"overmodulation-include_duty_clipping\": tru"
  "e,\"pll-tau\": 2.19,\"pll-omega1\": 116.5,\"pll-velocity_filter_threshold\": 1.0"
  ",\"encoder-lines\": 250.0,\"encoder-index_present\": false,\"encoder-tracking_lo"
  "op-tau\": 1.5,\"encoder-qei_sync-method\": \"align\",\"encoder-qei_sync-align-t_"
  "align\": 0.5,\"encoder-qei_sync-align-angle_shift\": 30.0,\"encoder-qei_sync-ali"
  "gn-angle_init\": -30.0,\"encoder-qei_sync-align_sweep-sweep_rate_pow\": 1.0,\"en"
  "coder-qei_sync-align_sweep-setup_angle\": 45.0,\"encoder-qei_sync-pullout-pullou"
  "t_slip\": 0.117,\"zsmt-excitation-kV\": 0.4,\"zsmt-excitation-kI\": 0.4,\"zsmt-p"
