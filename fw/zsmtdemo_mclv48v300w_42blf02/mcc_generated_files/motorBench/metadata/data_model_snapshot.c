...
__attribute__((section("diagnostics_cinfo, info"), keep)) char MCAF_data_model_snapshot[] =
  ...
  "e_outerloop-tau\": 25.0,\"mcapi-isSquaredTau\": 1.0,\"mcapi-iqTau\": 1.0,\"mcapi"
  "-adcIsrUserFunctions_enable\": false,\"board_service-uiServiceTiming\": 1.0,\"bo"
  "ard_service-uiButtonDebounceTime\": 7.0,\"board_service-uiButtonLongPressTime\":"
